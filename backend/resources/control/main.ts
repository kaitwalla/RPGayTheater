...
type PinnedScene = { id: string; name: string; primary_backdrop_asset_id: string | null; default_music_cue_id: string | null; base_stage_preset_id: string | null };
...
const SessionsView = defineComponent({
    ...
    template: `<main class="shell stack">
        ...
        <section v-if="presentation" class="panel stack"><h2>Presentation preview</h2><PresentationStage :backdrop-asset-id="presentation.state.backdrop_asset_id" :entries="activeEntries" :asset-urls="presentationAssetUrls" /></section>
