...
export const CampaignStudioView = defineComponent({
    setup() {
        ...
        onMounted(load);
        return { sections: studioSections, active, assets, activeAssets, archivedAssets, readyImages, readyAudio, readyVideos, stageEntries, selectedSceneId, selectedScene, mapTokens, selectedMap, selectedFog, filteredCueLibrary, studio, saving, error, busy, history, redoHistory, stagePresetId, mapId, fogAssetId, sceneModal, cueModalOpen, cueEditor, cueEditorAssets, cueFile, backdropFile, backdropUploadModalOpen, sceneForm, sceneCharacterForm, sceneBackdropForm, sceneStageEntryForm, cueSearch, cueScopeFilter, cueTypeFilter, cueSceneFilter, assetUrls, collectionName, libraryFile, mapFile, mapDraft, mapTokenDraft, playerCharacterDraft, npcDraft, castCreationKind, characterArtUploadModalOpen, characterArtUploadFile, characterArtUploadTarget, characterArtUploadNpcId, characterArtUploadEmotion, replacementAsset, replacementFile, cueDraft, cueDraftAssets, summary, records, title, inputValue, inputChecked, selectValue, textareaValue, cueType, cueResource, cueScope, sceneCues, sceneBackdrops, npcStates, isNpc, characterArtId, characterInitial, characterKind, emotionNames, emotionAssetId, setEmotionAsset, emotionKitComplete, saveEmotionKit, npcStateDraft, addNpcState, openCharacterArtUpload, closeCharacterArtUpload, chooseCharacterArtUpload, uploadCharacterArt, openReplacementModal, closeReplacementModal, chooseReplacementFile, replaceLibraryAsset, openSceneModal, closeSceneModal, openBackdropUploadModal, closeBackdropUploadModal, openCueModal, closeCueModal, selectScene, loadAssetUrl, queueWrite, undo, redo, addCollection, updateCollectionMembership, beginDrag, setFog, chooseLibraryFile, chooseMapFile, chooseCueFile, chooseBackdropFile, uploadLibraryFile, createMap, uploadMapFile, createMapToken, createCharacter, createCue, uploadBackdropFile, uploadCueFile, saveCue, makeCueGlobal, submitScene, submitSceneCharacter, submitSceneBackdrop, submitSceneStageEntry, remove, archiveAsset, deleteAsset, publish, back: () => router.push('/'), openLegacy: (section: string) => router.push(`/campaigns/${campaignId}/${section}`), openSessions: () => router.push(`/campaigns/${campaignId}/sessions`) };
    },
    template: `
