...
use App\Http\Controllers\Api\ControlCampaignStudioController;
...
use App\Http\Controllers\Api\ControlSessionMessageController;
...
use App\Http\Controllers\Api\ControlSessionPollController;
use App\Http\Controllers\Api\ControlSessionRollController;
...
use App\Http\Controllers\Api\ParticipantSessionMessageController;
use App\Http\Controllers\Api\ParticipantSessionPollController;
use App\Http\Controllers\Api\ParticipantSessionRollController;
...
Route::middleware(['web'])->prefix('control/v1')->group(function (): void {
    ...
    Route::middleware('control')->group(function (): void {
        ...
        Route::get('campaigns/{campaign}/studio', [ControlCampaignStudioController::class, 'show']);
        Route::post('campaigns/{campaign}/studio/asset-collections', [ControlCampaignStudioController::class, 'storeCollection']);
        Route::patch('campaigns/{campaign}/studio/{resource}/{record}', [ControlCampaignStudioController::class, 'update']);
        Route::delete('campaigns/{campaign}/studio/{resource}/{record}', [ControlCampaignStudioController::class, 'destroy']);
...
Route::middleware(['web'])->prefix('participant/v1')->group(function (): void {
    ...
    Route::get('messages', [ParticipantSessionMessageController::class, 'index']);
    Route::post('messages', [ParticipantSessionMessageController::class, 'store'])->middleware('throttle:session-messages');
